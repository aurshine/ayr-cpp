...
namespace ayr
{
	...
	struct IsSame<T1, T2, Args...> : std::bool_constant<IsSame<T1, T2>::value || IsSame<T1, Args...>::value> {};

	template<typename T1, typename T2>
	struct IsSame<T1, T2> : std::bool_constant<std::is_same_v<std::remove_cvref_t<T1>, std::remove_cvref_t<T2>>> {};
	...
	template<typename T1, typename T2, typename... Args>
	struct IsInstance<T1, T2, Args...> : std::bool_constant<IsInstance<T1, T2>::value || IsInstance<T1, Args...>::value> {};

	template<typename T1, typename T2>
	struct IsInstance<T1, T2> : std::bool_constant<std::is_base_of_v<T2, T1> || issame<T1, T2>> {};
